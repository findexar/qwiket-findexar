...
export function AppWrapper({ children,
  ...
  let sharedState = { fallback, isMobile, params, params2, tp, tp2, findexarxid, m, slug, view, tab, rtab, league, setView, setTab, setRtab, fbclid, utm_content, bot, setLeague, teamid, player, athleteUUId, setAthleteUUId, setTeamid, setPlayer, pagetype, setPagetype, mode, setMode, teamName, teamLogo, setTeamName, setTeamLogo, setFindexarxid, setM, setSlug, user, userAccount, userAccountMutate, prompt, promptUUId, feedback, setFeedback };
