...
export function AppWrapper({ children, 
  ...
  let sharedState = {fallback,isMobile,params, params2, tp, tp2,findexarxid, slug,view, tab,league,setView,setTab,fbclid, utm_content,setLeague,teamid,player,setTeamid,setPlayer,pagetype,setPagetype,mode,setMode,teamName,setTeamName};
