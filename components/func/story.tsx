                ...
                <HorizontalContainer>
                    ...
                    <Body>
                        ...
                        <Digest>
                            ...
                            <ContentCopyIcon style={{ paddingTop: 6, marginTop: -10, cursor: 'pointer', color: digestCopied ? 'green' : ''  }} fontSize="small"  onClick={() => onDigestCopyClick()} />
                        </Digest>
                    </Body>
                </HorizontalContainer>
                <ArticleMentions>
                    ...
                    <Body>
                        ...
                        <Digest>
                            ...
                            <ShareContainerInline>
                                <ContentCopyIcon style={{ paddingTop: 6, marginBottom: 0, marginTop: -10,color: digestCopied ? 'green' : ''  }} fontSize="small" onClick={() => onDigestCopyClick()} />
                            </ShareContainerInline>
                        </Digest>
                    </Body>
                </HorizontalContainer>
