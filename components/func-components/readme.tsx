...
const Readme = () => {
    return (
        <Container>
            ...
            <p className="mt-2">{process.env.NEXT_PUBLIC_APP_NAME} is a media mention tracking tool focused on professional teams and athletes across the Major Leagues: NFL, NHL, MLB, and NBA.</p>
