          ...
          <LeftContainer>
            ...
            <ContainerCenter>
              <HeaderCenter>
                ...
                {(pagetype == "league" || pagetype == "landing" || pagetype.includes("account")) && <div><Subhead $scrolled={scrollY != 0} className="text-xs md:text-sm">Elevate your fantasy game! Knowledge, Reasoning and Decision Support for Fantasy Sports and Betting Enthusiasts.</Subhead><SubheadMobile>Elevate your fantasy game!</SubheadMobile></div>}
