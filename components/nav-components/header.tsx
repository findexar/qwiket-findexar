...
const TeamNameGroup = styled.div<HeaderProps>`
    ...
    img {
        height: ${props => props.$scrolled ? '64px' : '76px'};
        width: auto;
        margin-left: 12px;
    ...
    <>
      ...
      <Header $scrolled={scrollY != 0}>
        <HeaderTopline>
          <LeftContainer>
            ...
            <ContainerCenter>
              <HeaderCenter>
                ...
                {(pagetype == "league" || pagetype == "landing" || pagetype.includes("account")) && <div><Subhead $scrolled={scrollY != 0} className="text-sm md:text-base">Elevate your fantasy game! Knowledge, Reasoning and Decision Support for Fantasy Sports and Betting Enthusiasts.</Subhead><SubheadMobile>Elevate your fantasy game!</SubheadMobile></div>}
          ...
          {false && (pagetype == "league" || pagetype == "landing" || pagetype == "team" || pagetype == "player" || pagetype.includes("account")) && <Wiggly className="hidden md:block">
