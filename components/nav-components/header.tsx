          ...
          <LeftContainer>
            ...
            <ContainerCenter>
              <HeaderCenter>
                ...
                {(pagetype == "league" || pagetype == "landing" || pagetype.includes("account")) && <div><Subhead $scrolled={scrollY != 0}>Sports Knowledge Central</Subhead><SubheadMobile>Sports Knowledge Central</SubheadMobile></div>}
