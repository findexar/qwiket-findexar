...
*/
  const paramsSSR: SSRParams = await params;
  const searchParamsSSR: SSRSearchParams = await searchParams as any;
  const { today, cstory, cm, b, jsonld, prompt, promptUUId, userInfo, dark, view, tab, rtab, fallback, fbclid, utm_content, bot, isMobile, story, findexarxid, m, league, pagetype, teamid, name, athleteUUId, teamName, ua, relatedContent, page } =
