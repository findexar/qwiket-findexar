...
export default async function Page({
    ...
    const paramsSSR: SSRParams = await params;
    const searchParamsSSR: SSRSearchParams = await searchParams as any;
    const { page, jsonld, prompt, promptUUId, userInfo, dark, view, tab, rtab, fallback, fbclid, utm_content, bot, isMobile, story, findexarxid, m, league, pagetype, teamid, name, athleteUUId, teamName, ua, relatedContent } =
